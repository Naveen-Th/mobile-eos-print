export default {
  ...
  receipts: {
    ...
    outstandingFromEarlier: 'Outstanding from earlier transactions',
    walkInCustomer: 'Walk-in Customer',
    recordPayment: 'Record Payment',
    noPrinterConnected: 'No Printer Connected',
    noPrinterMessage: 'Please connect to a thermal printer first.\n\nGo to Settings → Printer Setup',
    printSuccess: '✓ Receipt printed successfully!',
    printFailed: 'Print Failed',
    printFailedMessage: 'Failed to print receipt. Check printer connection.',
  },
  pos: {
    title: 'POS',
    greeting: {
  ...
  pendingBills: {
    title: 'Pending Bills',
    subtitle: 'Manage customer balances and payments',
    ...
    allSettled: 'All customers have settled their balances',
    customersWithBalance: '{{count}} customers with pending balance',
    customerWithBalance: '{{count}} customer with pending balance',
    bill: 'bill',
    bills: 'bills',
    total: 'Total',
    balanceDue: 'Balance Due',
    ...
    unpaid: 'UNPAID',
    pay: 'Pay',
    loadingBills: 'Loading pending bills...',
    recordPayment: 'Record Payment',
    customer: 'Customer',
    ...
    exceedsBalance: 'Payment amount cannot exceed remaining balance',
    paymentSuccess: 'Payment recorded successfully',
    paymentError: 'Failed to record payment',
    deleteBill: 'Delete Bill',
    deleteBillConfirm: 'Are you sure you want to delete this receipt for {{customer}}?',
