...
import ReceiptFirebaseService from '../src/services/business/ReceiptFirebaseService';
import { Receipt, ReceiptItem } from '../src/types';
 ...
 */
export const generateTestReceipts = async (count: number = 1000): Promise<void> => {
 ...
 */
export const generateQuickTest = async (): Promise<void> => {
  console.log('🧪 Running quick test with 10 receipts...');
  await generateTestReceipts(10);
};

// Export for direct use
export default {
  generate1000: () => generateTestReceipts(1000),
  generate500: () => generateTestReceipts(500),
  generate100: () => generateTestReceipts(100),
  generateQuickTest,
